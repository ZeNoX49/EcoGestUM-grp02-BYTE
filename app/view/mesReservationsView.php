...
<head>
    ...
    <link rel="stylesheet" href=<?php $_ENV['PATH']."assets/css/style-gestion.css" ?>>
    ...
    <div class="inner-content-wrapper">
        ...
        <div class="my-objects-grid reservation-grid">
            ...
            <?php foreach($reservations as $res): ?>
                <?php
                // Gestion de l'image
                $imgSrc = !empty($res['image_objet']) ? $_ENV['PATH'].'assets/image/uploads/'.$res['image_objet'] : 'https://via.placeholder.com/400x300?text=Pas+d\'image';
...
<script src=<?php echo $_ENV['PATH']."assets/js/popup-reservation.js" ?>></script>
</body>
</html>