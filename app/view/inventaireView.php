    ...
    <div class="inv-content">
        ...
        <div class="inv-filters-bar">
            <div class="inv-filters-left">
                <div class="inv-filter-item">
                    <label>Statut</label>
                    <select onchange="changerCategorieStatut(<?= $category ?? "'Toutes catégories'" ?>, this.value)"><option>Tous les statuts</option>
                ...
                <div class="inv-filter-item">
                    ...
                    <select id="categorieSelect" onchange="changerCategorieStatut(this.value,<?php if(isset($statut)) echo $statut; else echo null?>)">
        ...
        <div class="inv-table-container">
            <div class="inv-table-header-info">
                <span class="list-title">Liste des objets (<?php if(isset($objetsFiltered)) echo count($objetsFiltered)?>)</span>
            ...
            <table class="inv-table">
                ...
                <tbody>
                <?php if(isset($objetsFiltered)) foreach($objetsFiltered as $objet): ?>
                <tr>
                    <td>
                        <div class="obj-cell">
                            <?php
