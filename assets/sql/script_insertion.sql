...
-- Types d'evenement
INSERT INTO TYPEEVENEMENT (nom_type_evenement)
VALUES ('Collecte'),
...
VALUES ('Rapport mensuel janvier', 'Bilan des activites du mois', '2025-01-31', 6),
...
-- Communiques
INSERT INTO COMMUNIQUE (titre_communique, contenu_communique, date_communique, id_utilisateur)
VALUES ('Nouvelle plateforme', 'Lancement de la plateforme anti-gaspillage', '2025-01-15 10:00:00', 6),
...
-- Notifications
INSERT INTO NOTIFICATION (contenu_notification, date_notification)
VALUES ('Votre reservation a ete confirmee', '2025-02-20 10:30:00'),
...
-- Statistiques
INSERT INTO STATISTIQUE (date_statistique, type_statistique, valeur_statistique, id_utilisateur)
VALUES ('2025-01-31', 'Objets donnes', '125', 6),
...
VALUES (4, '2025-02-15', 3, 2),
       (7, '2025-02-18', 8, 1);

-- Associations Utilisateur-Departement
INSERT INTO REGROUPER (id_utilisateur, id_depser)
VALUES (1, 1),
       (2, 1),
       (3, 2),
       (7, 4),
...
-- Signalements
INSERT INTO SIGNALER (id_objet, id_utilisateur, description_signalement, date_signalement)
VALUES (2, 3, 'Description ne correspond pas a l''etat reel', '2025-02-13 16:00:00'),
       (6, 1, 'Taille incorrecte dans la description', '2025-02-17 17:30:00');

-- Inscriptions evenements
INSERT INTO INSCRIRE (id_utilisateur, id_evenement)
VALUES (1, 1),
       (2, 1),
       (3, 2),
       (7, 3),
...
INSERT INTO RECEVOIR (id_utilisateur, id_notification)
VALUES (1, 4),
       (2, 2),
       (3, 1),
       (7, 3),
